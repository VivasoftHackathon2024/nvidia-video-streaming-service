...
const AssaultAgentComponent = ({ assaultEvaluation }) => {
    ...
    // const parsedData = assaultEvaluation;


    const parsedData = assaultEvaluation?.assault_evaluation ?
        JSON.parse(assaultEvaluation.assault_evaluation) : null;
    ...
    const lastIndex = parsedData.assault_incidents.length - 1;
    const lastIncidentSeverity = parsedData.assault_incidents[lastIndex].severity;
    ...
    return (
        <Accordion sx={{
            ...
            <AccordionDetails sx={{ border: 1 }}>
                ...
                <Stack spacing={2}>
                    {parsedData.assault_incidents.slice(0, lastIndex).map((incident, index) => (
                        <Card
                            key={index}
                            sx={{
...
export default AssaultAgentComponent;